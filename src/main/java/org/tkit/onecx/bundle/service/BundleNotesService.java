...
//    public void createBundleNotes(BundleOption bundleOptions) throws IOException, InterruptedException {
...
//    private void executeNotes(BundleOption bundleOptions, GitHub gitHubClient) throws Exception {
//        Log.info("Start generating notes...");
//        Map<String, Product> products = new HashMap<>(); //ProductLoader.loadProducts(bundleOptions, gitHubClient);
//
...
//        var content = tmp.data(context).render();
//
...
//    }
//
//    public String findFirstCommit(GHRepository repo, BundleOption flags, Product product, Component component)
//            throws IOException {
...
//    }
//
//    public static Map<String, Object> prepareTemplateContext(BundleOption bundleOptions, Map<String, Product> products) {
...
//    }
//
//    protected void writeToFile(Path out1, String data) {
//        try {
